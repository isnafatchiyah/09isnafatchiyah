                        ...
                        <form action="{{ route('pengajar.update', $pengajar->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_guru" class="form-control" id="exampleDropdown">
                                    @foreach ($guru as $mapels)
                                    <option value="{{ $mapels->id }}" @if($mapels->id == $pengajar->id_guru) selected @endif>{{ $mapels->nama }}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_mapel" class="form-control" id="exampleDropdown">
                                   ...
                                   <option value="{{ $item->id }}" @if($item->id == $pengajar->id_mapel) selected @endif>{{ $item->nama_mapel }}</option>
                                   @endforeach
